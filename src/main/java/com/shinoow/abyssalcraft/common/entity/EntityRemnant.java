...
public class EntityRemnant extends ACMob implements IMerchant, IOmotholEntity {
	 ...
	 * Insult generator
	 * 
	 * @param num Which insult to pick, number should be generated through
	 *            Random.nextInt(3)
	...
	/**
	 * Used by Minions of The Gatekeeper to set the attack target and enrage the
	 * Remnant
	 * 
	...
	/**
	 * Calling this method will make the Remnant hostile. Ever wanted to see a angry
	...
	protected String getDeathSound() {
		return "abyssalcraft:remnant.scream";
	}
	...
	private void addDefaultEquipmentAndRecipies(int par1) {
		...
		case 4:
			...
			addItemTrade(list, AbyssalCraft.Corbone, rand, adjustProbability(0.7F));
	...
	public void useRecipe(MerchantRecipe var1) {
		...
		if (var1.getItemToSell().getItem() instanceof ItemTool || var1.getItemToSell().getItem() instanceof ItemArmor) {
			var1.incrementToolUses();
			var1.incrementToolUses();
			var1.incrementToolUses();
		}
		if (var1.getItemToBuy().getItem() instanceof ItemNecronomicon || var1.getItemToBuy().getItem() instanceof ItemDrainStaff)
			var1.func_82785_h();
