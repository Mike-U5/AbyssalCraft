...
public class InternalNecroDataHandler extends DummyNecroDataHandler {
	...
	public void registerInternalPages() {
		...
		addPages("overworld", "materials", new Page(1, new ItemStack(AbyssalCraft.abyore), NecronomiconText.MATERIAL_ABYSSALNITE_1),
		...
		addPages("overworld", "specialmaterials", new Page(1, new CraftingStack(AbyssalCraft.CoraliumInfusedStone, Blocks.stone, Blocks.stone, Blocks.stone, AbyssalCraft.Coraliumcluster3,
				AbyssalCraft.Coraliumcluster3, AbyssalCraft.Coraliumcluster3, Blocks.stone, Blocks.stone, Blocks.stone),
		...
		addPages("overworld", "armortools", new Page(1, new CraftingStack(AbyssalCraft.drainStaff), NecronomiconText.CRAFTING_STAFF_OF_RENDING_1),
				new Page(2, NecronomiconText.CRAFTING_STAFF_OF_RENDING_2));
		addPages("abyssalwasteland", "materials", new Page(1, new ItemStack(AbyssalCraft.abystone), NecronomiconText.MATERIAL_ABYSSAL_STONE_1),
		...
		addPages("abyssalwasteland", "specialmaterials", new Page(1, new CraftingStack(new ItemStack(AbyssalCraft.PSDLfinder, 4)),
				...
				new Page(5, new CraftingStack(AbyssalCraft.Cchunk), NecronomiconText.CRAFTING_CORALIUM_CHUNK),
				new Page(6, new CraftingStack(AbyssalCraft.Cplate), NecronomiconText.CRAFTING_CORALIUM_PLATE),
				new Page(7, new CraftingStack(new ItemStack(AbyssalCraft.skin, 1, 1)), NecronomiconText.CRAFTING_SKIN_OF_THE_DREADLANDS_1),
				new Page(8, new CraftingStack(AbyssalCraft.necronomicon_dre), NecronomiconText.CRAFTING_NECRONOMICON_D));
		addPages("abyssalwasteland", "armortools", new Page(1, new CraftingStack(AbyssalCraft.CorhelmetP),
		...
		addPages("dreadlands", "materials", new Page(1, new ItemStack(AbyssalCraft.dreadstone), NecronomiconText.MATERIAL_DREADSTONE_1),
		...
		addPages("dreadlands", "specialmaterials", new Page(1, new CraftingStack(AbyssalCraft.dreadiumblock), NecronomiconText.CRAFTING_DREADIUM_1),
		...
		addPages("dreadlands", "armortools", new Page(1, new CraftingStack(AbyssalCraft.dreadiumShelmet),
		...
		addPages("omothol", "materials", new Page(1, new ItemStack(AbyssalCraft.omotholstone), NecronomiconText.MATERIAL_OMOTHOL_STONE_1),
		...
		addPages("omothol", "entities", new Page(1, NecronomiconResources.REMNANT, NecronomiconText.ENTITY_REMNANT_1),
				...
				new Page(10, NecronomiconText.ENTITY_LESSER_SHOGGOTH_2));
		addPages("omothol", "specialmaterials", new Page(1, new CraftingStack(AbyssalCraft.lifeCrystal), NecronomiconText.CRAFTING_LIFE_CRYSTAL_1),
		...
		addPages("rituals", "materials", new Page(1, new ItemStack(AbyssalCraft.ritualaltar), NecronomiconText.MATERIAL_RITUAL_ALTAR_1),
		...
		addPages("rituals", "specialmaterials", new Page(1, new CraftingStack(AbyssalCraft.energyPedestal), NecronomiconText.CRAFTING_ENERGY_PEDESTAL_1),
		...
		addPages("miscinfo", "specialmaterials", new Page(1, new CraftingStack(AbyssalCraft.CobbleU), NecronomiconText.CRAFTING_UPGRADE_KIT_1),
				...
				new Page(3, new CraftingStack(AbyssalCraft.carbonCluster), NecronomiconText.CRAFTING_CARBON_CLUSTER),
				new Page(4, new CraftingStack(AbyssalCraft.denseCarbonCluster), NecronomiconText.CRAFTING_DENSE_CARBON_CLUSTER),
				new Page(5, new CraftingStack(AbyssalCraft.Crate), NecronomiconText.CRAFTING_CRATE));
