...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderThings() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityWormHole.class, new RenderWormHole(new ModelWormHole(true), 1.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityDreadSlug.class, new RenderSnowball(AbyssalCraft.dreadeye));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityAbomination.class, new RenderAbomination());
