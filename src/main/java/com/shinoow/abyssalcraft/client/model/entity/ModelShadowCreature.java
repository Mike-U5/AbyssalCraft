...
public class ModelShadowCreature extends ModelBase {
	...
	public ModelShadowCreature() {
		...
		Tail7.setRotationPoint(-2F, f + 3F, 7F);
		...
		LeftArm1.setRotationPoint(0F, f + 3F, 0F);
		...
		RightArm1.setRotationPoint(-5F, f + 3F, 0F);
		...
		LeftArm2.setRotationPoint(1F, f + 3F, 0F);
		...
		RightArm2.setRotationPoint(-5F, f + 3F, 0F);
