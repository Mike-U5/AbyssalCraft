...
public class RenderDragonMinion extends RenderLiving {
	 ...
	 * rotateCorpse method.
	 */
	protected void rotateDragonBody(EntityDragonMinion dragon, float par2, float par3, float par4) {
	 ...
	 */
	protected void renderDragonModel(EntityDragonMinion dragon, float par2, float par3, float par4, float par5, float par6, float par7) {
	 ...
	 * shouldRenderPass.
	 */
	protected int renderGlow(EntityDragonMinion entity, int par2, float par3) {
		if (par2 == 1) {
			GL11.glDepthFunc(GL11.GL_LEQUAL);
		}
	...
	public void doRenderLiving(EntityLiving entity, double par2, double par4, double par6, float par8, float par9) {
		renderDragon((EntityDragonMinion) entity, par2, par4, par6, par8, par9);
	}
	...
	protected int shouldRenderPass(EntityLivingBase entity, int par2, float par3) {
		return renderGlow((EntityDragonMinion) entity, par2, par3);
	}

	@Override
	protected void rotateCorpse(EntityLivingBase entity, float par2, float par3, float par4) {
		rotateDragonBody((EntityDragonMinion) entity, par2, par3, par4);
	}
	...
	protected void renderModel(EntityLivingBase entity, float par2, float par3, float par4, float par5, float par6, float par7) {
		renderDragonModel((EntityDragonMinion) entity, par2, par3, par4, par5, par6, par7);
	}
	...
	protected void preRenderCallback(EntityLivingBase entity, float par2) {
		preRenderScale((EntityDragonMinion) entity, par2);
	}

	@Override
	protected ResourceLocation getEntityTexture(Entity entity) {
		return func_110841_a((EntityDragonMinion) entity);
	}
